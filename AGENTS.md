...
- Design modules so they can grow independently: residents, visitors, billing, maintenance, security, and notifications should not become tightly coupled blobs.
...
- Any feature that affects residents, visitors, security incidents, access control, or billing must leave an audit-friendly trail.
